...
export default function AdminDashboard() {
  ...
  React.useEffect(()=>{
    ;(async ()=>{
      let resp = { data: { data: [] } }
      try { resp = await axios.get('/admin/submissions/data', { params: { start:0, length:50, draw:1 } }) } catch(e){}
    ...
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
        <div className="bg-vicinity-card rounded-xl p-6 shadow-lg border border-vicinity-text/10">
          <div className="flex items-center justify-between"><p className="text-sm text-vicinity-text/70">Total</p><FiUsers /></div>
